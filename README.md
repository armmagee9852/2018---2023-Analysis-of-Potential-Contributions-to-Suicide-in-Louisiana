...
**Observations**
<br/>
Here are the age-specific suicide rates by age demographics, sourced through the CDC WONDER. This data was found by dividing the cumulative deaths per demographic by their cumulative population, then multiplied by 100,000 for standardization. The reason age-specific rates are used is to standardize the rates by demographic in disregard for bigger or smaller populations. Data for the 5–14 age group was suppressed due to low counts and is omitted from the visualization, but it remains relevant for overall analysis. By comparing our highest and lowest demographics, there is a **staggering 53.42%** increase in mortality rates from 15-24 year olds to 45-54 years old, an immense percentage that leaves more room for research or gathered data to investigate. <br/>
